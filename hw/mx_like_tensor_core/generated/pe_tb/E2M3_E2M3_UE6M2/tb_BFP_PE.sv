...
// Combo: E2M3 x E2M3 / UE6M2   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.11768341064453125;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E2M3_E2M3_UE6M2.vcd");
    $dumpvars(0, tb_BFP_PE);

    stim_a[0] = 24'd6666697;
    stim_a[1] = 24'd4464593;
    stim_a[2] = 24'd15059990;
    stim_a[3] = 24'd7869809;
    ...
    $display("[tb E2M3_E2M3_UE6M2] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E2M3_E2M3_UE6M2] RESULT: PASS");
    else
      $display("[tb E2M3_E2M3_UE6M2] RESULT: FAIL");
