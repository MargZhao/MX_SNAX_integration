...
// Combo: E5M2 x E3M2 / UE7M1   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.13953399658203125;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E5M2_E3M2_UE7M1.vcd");
    ...
    stim_a[8] = 32'd3942245725;
    stim_a[9] = 32'd3906824292;
    stim_a[10] = 32'd1709631847;
    stim_a[11] = 32'd1541759724;
    ...
    $display("[tb E5M2_E3M2_UE7M1] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E5M2_E3M2_UE7M1] RESULT: PASS");
    else
      $display("[tb E5M2_E3M2_UE7M1] RESULT: FAIL");
