...
// Combo: E5M2 x E4M3 / UE7M1   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.13355684280395508;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E5M2_E4M3_UE7M1.vcd");
    ...
    stim_b[12] = 32'd4150884475;
    stim_b[13] = 32'd1794666678;
    stim_b[14] = 32'd4042748267;
    stim_b[15] = 32'd3967547371;
    stim_sa[0] = 8'd94;
    stim_sa[1] = 8'd94;
    stim_sa[2] = 8'd94;
    stim_sa[3] = 8'd94;
    ...
    $display("[tb E5M2_E4M3_UE7M1] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E5M2_E4M3_UE7M1] RESULT: PASS");
    else
      $display("[tb E5M2_E4M3_UE7M1] RESULT: FAIL");
