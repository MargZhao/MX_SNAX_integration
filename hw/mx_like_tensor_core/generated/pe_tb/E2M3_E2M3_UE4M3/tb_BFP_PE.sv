...
// Combo: E2M3 x E2M3 / UE4M3   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.12403392791748047;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E2M3_E2M3_UE4M3.vcd");
    ...
    stim_a[4] = 24'd15129799;
    stim_a[5] = 24'd7152891;
    stim_a[6] = 24'd8038389;
    stim_a[7] = 24'd6593903;
    stim_a[8] = 24'd9697408;
    stim_a[9] = 24'd9306305;
    stim_a[10] = 24'd665859;
    stim_a[11] = 24'd139367;
    stim_a[12] = 24'd9187433;
    stim_a[13] = 24'd1329030;
    stim_a[14] = 24'd9961731;
    ...
    $display("[tb E2M3_E2M3_UE4M3] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E2M3_E2M3_UE4M3] RESULT: PASS");
    else
      $display("[tb E2M3_E2M3_UE4M3] RESULT: FAIL");
