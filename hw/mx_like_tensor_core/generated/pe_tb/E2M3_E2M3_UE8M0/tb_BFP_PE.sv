...
// Combo: E2M3 x E2M3 / UE8M0   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.1273040771484375;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E2M3_E2M3_UE8M0.vcd");
    $dumpvars(0, tb_BFP_PE);

    stim_a[0] = 24'd6396296;
    stim_a[1] = 24'd4202319;
    stim_a[2] = 24'd14793684;
    stim_a[3] = 24'd7345392;
    stim_a[4] = 24'd14064580;
    stim_a[5] = 24'd6087671;
    stim_a[6] = 24'd6715057;
    stim_a[7] = 24'd5270634;
    stim_a[8] = 24'd9697408;
    stim_a[9] = 24'd9306305;
    stim_a[10] = 24'd665859;
    stim_a[11] = 24'd139367;
    stim_a[12] = 24'd8921190;
    stim_a[13] = 24'd800388;
    stim_a[14] = 24'd9437378;
    stim_a[15] = 24'd411808;
    stim_b[0] = 24'd575618;
    stim_b[1] = 24'd4538858;
    stim_b[2] = 24'd445741;
    stim_b[3] = 24'd12273979;
    stim_b[4] = 24'd6880050;
    stim_b[5] = 24'd3622757;
    stim_b[6] = 24'd15163672;
    stim_b[7] = 24'd10719793;
    stim_b[8] = 24'd1852067;
    stim_b[9] = 24'd5830828;
    stim_b[10] = 24'd4019636;
    stim_b[11] = 24'd6646149;
    stim_b[12] = 24'd13399320;
    stim_b[13] = 24'd2048800;
    stim_b[14] = 24'd11744072;
    stim_b[15] = 24'd10849512;
    stim_sa[0] = 8'd124;
    stim_sa[1] = 8'd124;
    stim_sa[2] = 8'd124;
    stim_sa[3] = 8'd124;
    ...
    $display("[tb E2M3_E2M3_UE8M0] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E2M3_E2M3_UE8M0] RESULT: PASS");
    else
      $display("[tb E2M3_E2M3_UE8M0] RESULT: FAIL");
