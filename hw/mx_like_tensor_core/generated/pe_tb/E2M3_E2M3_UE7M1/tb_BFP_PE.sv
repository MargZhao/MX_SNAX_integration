...
// Combo: E2M3 x E2M3 / UE7M1   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.11872100830078125;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E2M3_E2M3_UE7M1.vcd");
    ...
    stim_a[4] = 24'd15125638;
    stim_a[5] = 24'd6886586;
    stim_a[6] = 24'd7509876;
    stim_a[7] = 24'd6327598;
    stim_a[8] = 24'd9697408;
    stim_a[9] = 24'd9306305;
    stim_a[10] = 24'd665859;
    stim_a[11] = 24'd139367;
    stim_a[12] = 24'd9187432;
    stim_a[13] = 24'd1324870;
    stim_a[14] = 24'd9961667;
    stim_a[15] = 24'd420065;
    stim_b[0] = 24'd854211;
    ...
    stim_b[8] = 24'd2380708;
    stim_b[9] = 24'd6629616;
    stim_b[10] = 24'd4818552;
    stim_b[11] = 24'd7444999;
    stim_b[12] = 24'd14456347;
    stim_b[13] = 24'd2851872;
    stim_b[14] = 24'd12809291;
    stim_b[15] = 24'd11648491;
    stim_sa[0] = 8'd120;
    stim_sa[1] = 8'd120;
    stim_sa[2] = 8'd120;
    stim_sa[3] = 8'd120;
    ...
    $display("[tb E2M3_E2M3_UE7M1] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E2M3_E2M3_UE7M1] RESULT: PASS");
    else
      $display("[tb E2M3_E2M3_UE7M1] RESULT: FAIL");
