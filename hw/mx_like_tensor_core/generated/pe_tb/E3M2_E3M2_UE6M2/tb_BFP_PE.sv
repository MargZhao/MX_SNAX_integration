...
// Combo: E3M2 x E3M2 / UE6M2   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.1374073028564453;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E3M2_E3M2_UE6M2.vcd");
    ...
    stim_a[8] = 24'd12577411;
    stim_a[9] = 24'd11940681;
    stim_a[10] = 24'd2800524;
    stim_a[11] = 24'd696817;
    stim_a[12] = 24'd12116404;
    stim_a[13] = 24'd4519826;
    stim_a[14] = 24'd13116366;
    stim_a[15] = 24'd2304932;
    stim_b[0] = 24'd3242893;
    stim_b[1] = 24'd6665526;
    stim_b[2] = 24'd2064120;
    stim_b[3] = 24'd14924926;
    stim_b[4] = 24'd7703993;
    stim_b[5] = 24'd6268849;
    stim_b[6] = 24'd15971292;
    stim_b[7] = 24'd13882680;
    stim_b[8] = 24'd5314032;
    stim_b[9] = 24'd7707576;
    stim_b[10] = 24'd6670204;
    stim_b[11] = 24'd7986451;
    ...
    $display("[tb E3M2_E3M2_UE6M2] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E3M2_E3M2_UE6M2] RESULT: PASS");
    else
      $display("[tb E3M2_E3M2_UE6M2] RESULT: FAIL");
