...
// Combo: E3M2 x E3M2 / UE4M4   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.1359572410583496;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E3M2_E3M2_UE4M4.vcd");
    ...
    stim_b[12] = 24'd15812382;
    stim_b[13] = 24'd5752353;
    stim_b[14] = 24'd14923285;
    stim_b[15] = 24'd14278389;
    stim_sa[0] = 8'd30;
    stim_sa[1] = 8'd30;
    stim_sa[2] = 8'd30;
    stim_sa[3] = 8'd30;
    ...
    $display("[tb E3M2_E3M2_UE4M4] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E3M2_E3M2_UE4M4] RESULT: PASS");
    else
      $display("[tb E3M2_E3M2_UE4M4] RESULT: FAIL");
