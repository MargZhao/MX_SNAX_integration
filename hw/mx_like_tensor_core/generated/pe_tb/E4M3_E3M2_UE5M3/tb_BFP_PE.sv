...
// Combo: E4M3 x E3M2 / UE5M3   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.12641125917434692;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E4M3_E3M2_UE5M3.vcd");
    $dumpvars(0, tb_BFP_PE);

    stim_a[0] = 32'd2021320040;
    stim_a[1] = 32'd1901330032;
    stim_a[2] = 32'd4168937589;
    stim_a[3] = 32'd2102555888;
    ...
    stim_b[0] = 24'd3505038;
    stim_b[1] = 24'd6669622;
    stim_b[2] = 24'd2326264;
    stim_b[3] = 24'd14924927;
    stim_b[4] = 24'd7703993;
    stim_b[5] = 24'd6273009;
    stim_b[6] = 24'd16233501;
    stim_b[7] = 24'd13882681;
    stim_b[8] = 24'd5580272;
    stim_b[9] = 24'd7707640;
    stim_b[10] = 24'd6674300;
    stim_b[11] = 24'd8248595;
    stim_b[12] = 24'd16078687;
    stim_b[13] = 24'd6018657;
    stim_b[14] = 24'd15189590;
    stim_b[15] = 24'd14548791;
    stim_sa[0] = 8'd47;
    stim_sa[1] = 8'd47;
    stim_sa[2] = 8'd47;
    stim_sa[3] = 8'd47;
    ...
    $display("[tb E4M3_E3M2_UE5M3] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E4M3_E3M2_UE5M3] RESULT: PASS");
    else
      $display("[tb E4M3_E3M2_UE5M3] RESULT: FAIL");
