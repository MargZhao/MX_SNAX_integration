...
// Combo: INT8 x INT8 / UE7M1   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.12361335754394531;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_INT8_INT8_UE7M1.vcd");
    ...
    stim_a[12] = 32'd4194697967;
    stim_a[13] = 32'd151480075;
    stim_a[14] = 32'd4110485254;
    stim_a[15] = 32'd49675007;
    ...
    stim_b[8] = 32'd302717944;
    stim_b[9] = 32'd1260911327;
    stim_b[10] = 32'd658721985;
    stim_b[11] = 32'd1649012749;
    stim_b[12] = 32'd3289530970;
    stim_b[13] = 32'd348135680;
    stim_b[14] = 32'd3754238741;
    stim_b[15] = 32'd3881289450;
    stim_sa[0] = 8'd124;
    stim_sa[1] = 8'd124;
    stim_sa[2] = 8'd124;
    stim_sa[3] = 8'd124;
    ...
    $display("[tb INT8_INT8_UE7M1] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb INT8_INT8_UE7M1] RESULT: PASS");
    else
      $display("[tb INT8_INT8_UE7M1] RESULT: FAIL");
