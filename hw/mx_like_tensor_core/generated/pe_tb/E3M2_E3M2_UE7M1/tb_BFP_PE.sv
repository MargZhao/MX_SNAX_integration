...
// Combo: E3M2 x E3M2 / UE7M1   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.13929367065429688;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E3M2_E3M2_UE7M1.vcd");
    ...
    stim_a[8] = 24'd12311107;
    stim_a[9] = 24'd11678472;
    stim_a[10] = 24'd2534219;
    stim_a[11] = 24'd692656;
    ...
    $display("[tb E3M2_E3M2_UE7M1] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E3M2_E3M2_UE7M1] RESULT: PASS");
    else
      $display("[tb E3M2_E3M2_UE7M1] RESULT: FAIL");
