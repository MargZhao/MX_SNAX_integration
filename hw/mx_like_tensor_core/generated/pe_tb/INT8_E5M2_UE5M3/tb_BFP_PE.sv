...
// Combo: INT8 x E5M2 / UE5M3   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.12379002571105957;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_INT8_E5M2_UE5M3.vcd");
    ...
    stim_a[4] = 32'd3035026445;
    stim_a[5] = 32'd1512582312;
    stim_a[6] = 32'd1844213196;
    stim_a[7] = 32'd1192349154;
    ...
    stim_b[0] = 32'd1617617249;
    stim_b[1] = 32'd1819174889;
    stim_b[2] = 32'd1525346027;
    stim_b[3] = 32'd3958301937;
    stim_b[4] = 32'd1835591401;
    stim_b[5] = 32'd1743417057;
    stim_b[6] = 32'd3974848364;
    stim_b[7] = 32'd3840763112;
    stim_b[8] = 32'd1734633954;
    stim_b[9] = 32'd1869341162;
    stim_b[10] = 32'd1802399726;
    stim_b[11] = 32'd1903158885;
    stim_b[12] = 32'd3999755888;
    stim_b[13] = 32'd1743678157;
    stim_b[14] = 32'd3941493608;
    stim_b[15] = 32'd3916492264;
    stim_sa[0] = 8'd110;
    stim_sa[1] = 8'd110;
    stim_sa[2] = 8'd110;
    stim_sa[3] = 8'd110;
    ...
    $display("[tb INT8_E5M2_UE5M3] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb INT8_E5M2_UE5M3] RESULT: PASS");
    else
      $display("[tb INT8_E5M2_UE5M3] RESULT: FAIL");
