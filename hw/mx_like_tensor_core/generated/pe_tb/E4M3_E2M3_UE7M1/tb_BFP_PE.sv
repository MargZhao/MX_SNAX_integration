...
// Combo: E4M3 x E2M3 / UE7M1   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.11787700653076172;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E4M3_E2M3_UE7M1.vcd");
    ...
    stim_a[8] = 32'd3690647874;
    stim_a[9] = 32'd3653392464;
    stim_a[10] = 32'd1389615702;
    stim_a[11] = 32'd1053904097;
    ...
    $display("[tb E4M3_E2M3_UE7M1] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E4M3_E2M3_UE7M1] RESULT: PASS");
    else
      $display("[tb E4M3_E2M3_UE7M1] RESULT: FAIL");
