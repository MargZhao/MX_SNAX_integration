...
// Combo: E5M2 x E5M2 / UE7M1   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.13952112197875977;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E5M2_E5M2_UE7M1.vcd");
    ...
    stim_b[12] = 32'd4168120442;
    stim_b[13] = 32'd1912108247;
    stim_b[14] = 32'd4109857905;
    stim_b[15] = 32'd4068079601;
    stim_sa[0] = 8'd94;
    stim_sa[1] = 8'd94;
    stim_sa[2] = 8'd94;
    stim_sa[3] = 8'd94;
    ...
    $display("[tb E5M2_E5M2_UE7M1] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E5M2_E5M2_UE7M1] RESULT: PASS");
    else
      $display("[tb E5M2_E5M2_UE7M1] RESULT: FAIL");
